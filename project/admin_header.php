...
<header class="header">
   ...
   <div class="flex">
      ...
      <a href="admin_page.php" class="logo">Административная<span> панель</span></a>

      <nav class="navbar">
         <a href="admin_page.php">Домашняя</a>
      ...
      <div class="account-box">
         ...
         <p>электронная почта : <span><?php echo $_SESSION['admin_email']; ?></span></p>
