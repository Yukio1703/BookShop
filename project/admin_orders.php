...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Адрес электронной почты : <span><?php echo $fetch_orders['email']; ?></span> </p>
         <p> адрес : <span><?php echo $fetch_orders['address']; ?></span> </p>
         <p> общее количество продуктов : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
         <p> Итоговая цена : <span><?php echo $fetch_orders['total_price']; ?> руб.</span> </p>
         ...
         <form action="" method="post">
            ...
            <select name="update_payment">
               ...
               <option value="completed">подтверждён</option>
            </select>
