...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" placeholder="введите адрес электронной почты" required class="box">
      <input type="password" name="password" placeholder="Создайте пароль" required class="box">
      <input type="password" name="cpassword" placeholder="Подтвердите ваш пароль" required class="box">
      <select name="user_type" class="box">
         <option value="user">пользователь</option>
         <option value="admin">админ</option>
      </select>
      <input type="submit" name="submit" value="Зарегистрируйтесь Сейчас" class="btn">
